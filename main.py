...
#------------------------------------------------------------------------
labels_tw = { "b01a":["單片土司", 8], "b01b":["雙片土司", 16], "b01c":["一包土司", 20], "b02":["熱狗夾心", 60], \
           "b03":["糖霜奶心", 42], "b04":["牛角麵包", 30], "b05":["奶油牛奶條", 55], "b06":["紅豆麵包", 35], \
           "b07":["花生夾心", 28], "b08":["小圓麵包", 18], "b09":["炸甜甜圈", 30], "b10":["鬆軟捲餅", 52], "b11":["牛肉漢堡", 85] }

labels_en = { "b01a":["Toast", 0.4], "b01b":["Toasts", 0.8], "b01c":["White bread", 1.5], "b02":["Hot-dog bun", 4.0], \
           "b03":["Garlic Bread", 4.2], "b04":["Croissant", 2.6], "b05":["Baguette", 1.8], "b06":["Red-bean bun", 0.6], \
           "b07":["Peanut bread", 1.2], "b08":["Bun", 0.2], "b09":["Donut", 2.2], "b10":["Swiss-roll", 3.8], "b11":["Hamburger", 5.2] }
